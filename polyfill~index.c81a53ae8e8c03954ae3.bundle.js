...
var fails = __webpack_require__(13); // Thank's IE8 for his funny defineProperty
...
var toString = __webpack_require__(134); // `Object.prototype.toString` method
...
var requireObjectCoercible = __webpack_require__(40); // `ToObject` abstract operation
...
var requireObjectCoercible = __webpack_require__(40); // `String.prototype.{ codePointAt, at }` methods implementation
...
var createElement = __webpack_require__(72); // Thank's IE8 for his funny defineProperty
...
var anObject = __webpack_require__(14); // call something on iterator step with safe closing on error
...
var regExpExec = __webpack_require__(106); // @@search logic
...
var objectKeys = __webpack_require__(109); // `Object.defineProperties` method
...
var enumBugKeys = __webpack_require__(77); // `Object.keys` method
...
var CORRECT_PROTOTYPE_GETTER = __webpack_require__(169);
...
var aPossiblePrototype = __webpack_require__(170); // `Object.setPrototypeOf` method
...
var getIteratorMethod = __webpack_require__(64); // `Array.from` method implementation
...
var classof = __webpack_require__(76); // `Object.prototype.toString` method implementation
// https://tc39.github.io/ecma262/#sec-object.prototype.tostring
...
var anObject = __webpack_require__(14); // all object keys, includes non-enumerable and symbols
...
var toAbsoluteIndex = __webpack_require__(93); // `Array.prototype.{ indexOf, includes }` methods implementation
...
var anObject = __webpack_require__(14); // `RegExp.prototype.flags` getter implementation
...
var fails = __webpack_require__(13); // babel-minify transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError,
...
var toASCII = __webpack_require__(174);
...
var charAt = __webpack_require__(83).charAt; // `AdvanceStringIndex` abstract operation
...
var arrayMethodUsesToLength = __webpack_require__(122);
...
var assign = __webpack_require__(117); // `Object.assign` method
// https://tc39.github.io/ecma262/#sec-object.assign
...
var $map = __webpack_require__(191).map;
...
//# sourceMappingURL=polyfill~index.c81a53ae8e8c03954ae3.bundle.js.map